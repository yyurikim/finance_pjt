<template>
  <div class="container">
    ...
    <div class="form">
      <input type="text" :value="formattedSavingAmount" @input="updateSavingAmount($event.target.value)" placeholder="매달 저축하고 싶은 금액" class="input-field">
      <input type="text" :value="formattedDepositAmount" @input="updateDepositAmount($event.target.value)" placeholder="현재 보유중인 금액" class="input-field">
...
.button-like:hover {
  background-color: rgb(118, 193, 223);
}
