...
.centered-container {
  ...
  top: 0; /* Adjust the top margin to leave space for nav */
  left: 0;
  right: 0;
  bottom: 0;
  z-index: 2; /* Ensure centered content is above nav and title background */
}
...
.test {
  ...
  width: 97%;
  margin: 0 auto;
  margin-top: -50px; /* Adjust this value as needed to pull it up */
